...
export const dict: Dict = {
  ...
  setDictationKeyHintPc: "Сочетание перехватывается раньше всех программ. В режиме удержания отпускайте сначала букву или пробел: если отпустить Ctrl и Alt раньше, символ напечатается в поле.",
  setDictationKeyHintWin: "Одна клавиша, как на Mac: в одиночку она ничего не печатает. Правый Alt на раскладках с AltGr (польская, немецкая и др.) набирает буквы — там берите правый Ctrl. Caps Lock, выбранный триггером, перестаёт переключать регистр.",
  hotkeyRightOption: "Правый ⌥",
  hotkeyRightCommand: "Правый ⌘",
  hotkeyRightCtrl: "Правый Ctrl",
  hotkeyRightAlt: "Правый Alt",
  ...
  setDictationDeliveryHintPc: "«Печатать» набирает текст там, где стоит курсор, и не трогает буфер обмена. «В буфер» кладёт текст в буфер — вставите сами.",
  ...
  dictWayland: "В сеансе Wayland система не даёт программам перехватывать сочетания клавиш и печатать в чужие окна, поэтому здесь диктовка пока не работает. В сеансе X11 она работает.",
  ...
  setDictationMicHintPc: "«Как в системе» — вход по умолчанию. Если запись выходит пустой, выберите микрофон явно.",
  micGranted: "Разрешён",
