...
export const dict = {
  ...
  setDictationKeyHintPc: "The combination is caught before any other app sees it. In hold mode let go of the letter or Space first: release Ctrl and Alt earlier and the character gets typed into the field.",
  setDictationKeyHintWin: "One key, like on a Mac: on its own it types nothing. On layouts with AltGr (Polish, German and others) Right Alt types letters — use Right Ctrl there. Caps Lock picked as the trigger stops switching case.",
  hotkeyRightOption: "Right ⌥",
  hotkeyRightCommand: "Right ⌘",
  hotkeyRightCtrl: "Right Ctrl",
  hotkeyRightAlt: "Right Alt",
  ...
  setDictationDeliveryHintPc: "“Type it” types the text where the cursor is and leaves the clipboard alone. “Clipboard” puts the text on the clipboard for you to paste.",
  ...
  dictWayland: "In a Wayland session the system doesn't let apps catch key combinations or type into other windows, so dictation doesn't work here yet. It works in an X11 session.",
  ...
  setDictationMicHintPc: "“System” is the default input device. If recordings come out empty, pick the microphone explicitly.",
  micGranted: "Granted",
