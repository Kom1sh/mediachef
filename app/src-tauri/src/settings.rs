...
pub struct Dictation {
    ...
    /// всегда. `"paste"` дополнительно нажимает Cmd+V в активном окне и на
    /// macOS требует разрешения «Универсальный доступ». Разрешение проверяется
...
fn sanitize_dictation(mut d: Dictation) -> Dictation {
    ...
    d.delivery = one_of(d.delivery, &["clipboard", "paste"], "clipboard");
