...
/**
 * Какой странице соответствует плитка в блоке «что умеет из коробки» на
 * главной. Порядок ровно тот же, что у `ui.recipes` в файлах локалей; `null` —
 * задача есть в программе, а отдельной страницы под неё пока нет.
 *
 ...
 * не могут.
 */
export const HOME_TILE_PAGES: readonly (PageId | null)[] = [
  "mp3",         // Извлечь аудио в MP3
  "srt",         // Субтитры к видео
  "compress",    // Сжать видео
  "gif",         // Видео в GIF
  "transcribe",  // Аудио в текст
  null,          // Перевод речи в английский — своей страницы нет
  null,          // MP4 в MKV — своей страницы нет
  null,          // Убрать звук — своей страницы нет
  "trim",        // Обрезать видео
