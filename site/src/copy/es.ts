...
export const ui = {
  ...
  consent: {
    ...
    text: "Queremos usar Yandex Metrica y Google Analytics para ver cómo se usa el sitio: visitas, clics y descargas. Usan cookies y solo se activan si lo permites. La app MediaChef en sí no recoge nada.",
    allow: "Permitir",
    decline: "Rechazar",
