...
export const ui = {
  ...
  recipes: [
    ...
    { tile: "tile-purple", h: "Обрезать видео", p: "Вырезать кусок без перекодирования — мгновенно." },
    { tile: "tile-blue", h: "Голосовой ввод", p: "Зажали клавишу, сказали — текст появился там, где курсор." },
  ],
  ...
  contactNote:
    "Что-то не работает или чего-то не хватает? Напишите:",
  // ── общая обвязка ──
  ...
  fb: {
    title: "Обратная связь — MediaChef",
    description: "Расскажите, что не работает или чего не хватает. Форма работает в браузере, почтовый клиент не нужен.",
    h1: "Расскажите, что не так",
    crumb: "Обратная связь",
    lead: "Мы читаем всё, что здесь приходит, и отвечаем живым человеком. Если у вас что-то не сработало — самое полезное, что вы можете сделать, это написать сюда: без сообщений мы об этом просто не узнаём.",
    kindLabel: "О чём речь",
    kindBug: "Что-то не работает",
    kindIdea: "Есть предложение",
    messageLabel: "Сообщение",
    messagePlaceholder: "Что вы делали и что получилось вместо ожидаемого. Чем конкретнее, тем быстрее найдём причину.",
    contactLabel: "Куда ответить",
    contactHint: "Необязательно. Без адреса мы прочитаем сообщение, но ответить не сможем.",
    send: "Отправить",
    privacy: "Сохраняем только то, что вы написали, плюс версию и систему, если форму открыло приложение. Ни адрес IP, ни браузер, ни местоположение мы здесь не пишем.",
    mailAlt: "Привычнее письмом? Пишите на",
    thanks: "Спасибо — сообщение дошло.",
    thanksBody: "Мы его прочитаем. Если вы оставили адрес, ответим на него.",
  },
  ...
  consent: {
    ...
    noticeText: "Мы считаем визиты, клики и скачивания через Яндекс Метрику и Google Analytics — они используют cookies. Их можно отключить, сайт работает так же. Сама программа MediaChef ничего не собирает.",
    ok: "Хорошо",
    off: "Отключить",
  },
  tocLabel: "Содержание",
